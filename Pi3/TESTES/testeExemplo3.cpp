...
const int EMERGENCY_STOP_PIN = 15; //define the IO pin the emergency stop switch is connected to
const int LIMIT_SWITCH_PIN = 23;   //define the IO pin where the limit switches are connected to (switches in series in normally closed setup against ground)
